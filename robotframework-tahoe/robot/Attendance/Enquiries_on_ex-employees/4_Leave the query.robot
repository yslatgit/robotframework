*** Settings ***
Documentation     请假查询
Suite Setup       Set_Env    Xpath=//*[@id="nav-box"]/div[4]/div[2]/div[4]/a
Suite Teardown    GG
Force Tags
...
Advanced_search_by_name_and_type
    ...
    Sleep    1
    Click Element    Xpath=//div[@x-placement="bottom-start"]//li[2]    \    #选择类型
    Sleep    1
    Click Button    Xpath=//div[@class="fe-heightSerBox"]/div/button[1]    \    #点击确定
    Wait Until Page Contains    提交人
    Sleep    2
    ...
    : FOR    ${i}    IN    @{names}
    \    Should Be Equal As Strings    ${i.text}    出差
    [Teardown]    G_Clear_Search_Form
...
export_all
    ...
    ${info_xls}    Get Data From Excel    C:\\Users\\Administrator\\Downloads    离职请假单1    #从导出的excel中读取数据

*** Settings ***
Documentation     员工调班
Suite Setup       Set_Env    Xpath=//*[@id="nav-box"]/div[2]/div[2]/div[4]/a
Suite Teardown    GG
...
import_one
    [Documentation]    根据名称查询
    Wait Until Page Contains    工号
    G_Import_File    2    E:\\Data\\员工调班数据导入.xls    文件已导入，正在处理
    Sleep    2
    G_InputText    安铮
    Wait Until Page Contains    工号
    Sleep    2
...
staff_switch_batch
    [Documentation]    批量调班
    [Setup]    Set_Env    Xpath=//*[@id="nav-box"]/div[2]/div[2]/div[4]/a
    ${arg}    Set Variable    19
    Wait Until Page Contains    工号
    G_InputText    艾慧,艾敬
    Sleep    2

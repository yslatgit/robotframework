*** Settings ***
Documentation     补签卡管理
Suite Setup       Set_Env    Xpath=//*[@id="nav-box"]/div[2]/div[2]/div[8]/a
Suite Teardown    GG
Force Tags
...
export_one
    ...
    ${info}    Get Data From Excel    C:\\Users\\Administrator\\Downloads    补签卡1    #从导出的excel中读取数据
    ${result}    DB_data    ${retroactive_card_one}
    Log    ${info.pop(0)}
...
export_all
    ...
    ${page_num}    G_Get_Page_Count    Xpath=//span[@class="paginationText"]    #获取页面信息条数
    G_Click_Button    4    #点击导出
    ${info_xls}    Get Data From Excel    C:\\Users\\Administrator\\Downloads    补签卡1    #从导出的excel中读取数据
...
create_retroactive_card_satrt
    [Setup]    Set_Env    Xpath=//*[@id="nav-box"]/div[2]/div[2]/div[8]/a
    Wait Until Page Contains    工号
    G_InputText    艾慧
    Sleep    5
    ${page_num}    G_Get_Page_Count    Xpath=//span[@class="paginationText"]    #获取页面信息条数
